...
c=n("Vi3T"),l=n.n(c),u=a()({},l.a,{
    ...
    from:"从",stop:"停止",start:"启动",notice:"注意",learnMore:"了解更多",confirmDisconnect:"确认断开连接？",
    ...
    config:{
        ...
        help:{
            ...
            forwardFaq:"前往 FAQ",followUs:"关注我们"},
            analysis:{
                topicMetrics:"主题监控",
...
cHtD:function(e,t,n){"use strict";var s=n("7+uW"),a=n("/ocq"),o=n("olkN"),i=n("hQrB");s.default.use(a.a);
var r=[
    ...
    {path:"*",meta:{requiresAuth:!1},component:function(){return n.e(17).then(n.bind(null,"wkqA"))}}],c=new a.a({routes:r});c.beforeEach(function(e,t,n){var s=e.meta.requiresAuth;void 0===s||s?o.a.state.user.password?(i.a.indexOf(e.name)>-1&&o.a.dispatch("CANCEL_FEAT_ON_LEFTBAR",e.name),document.body.scrollTop=0,document.documentElement.scrollTop=0,n()):n({path:"/login",query:{redirect:e.fullPath}}):n()}),t.a=c},hQrB:function(e,t,n){"use strict";t.a=["rules"]},olkN:function(e,t,n){"use strict";var s,a,o=n("bOdI"),i=n.n(o),r=n("mvHQ"),c=n.n(r),l=n("7+uW"),u=n("NYxO"),d=n("7YgM"),p=n.n(d),m=n("hQrB");function h(e){try{return JSON.parse(e)}catch(e){return null}}l.default.use(u.a);var b={loading:!1,user:h(sessionStorage.getItem("user"))||h(localStorage.getItem("user"))||{},nodeName:"",showFeatOnLeftbar:function(){var e=h(localStorage.getItem("showFeatOnLeftbar"));function t(){var e={};m.a.forEach(function(t){e[t]=!0});var t={version:p.a.version,data:e};return localStorage.setItem("showFeatOnLeftbar",c()(t)),t}return e?e.version!==p.a.version?(localStorage.removeItem("showFeatOnLeftbar"),t()):e:t()}()},f=(s={},i()(s,"USER_LOGIN",function(e,t){var n=e.commit;if(t.isLogOut)return sessionStorage.removeItem("user"),localStorage.removeItem("user"),void n("USER_LOGIN",t);t.remember?localStorage.setItem("user",c()(t.user)):sessionStorage.setItem("user",c()(t.user)),n("USER_LOGIN",t)}),i()(s,"CURRENT_NODE",function(e,t){(0,e.commit)("CURRENT_NODE",t)}),i()(s,"LOADING",function(e){(0,e.commit)("LOADING",arguments.length>1&&void 0!==arguments[1]&&arguments[1])}),i()(s,"CANCEL_FEAT_ON_LEFTBAR",function(e,t){(0,e.commit)("CANCEL_FEAT_ON_LEFTBAR",t)}),s),g=(a={},i()(a,"USER_LOGIN",function(e,t){t.isLogOut?l.default.set(e,"user",{}):l.default.set(e,"user",t.user)}),i()(a,"CURRENT_NODE",function(e,t){l.default.set(e,"nodeName",t)}),i()(a,"LOADING",function(e,t){e.loading=t}),i()(a,"CANCEL_FEAT_ON_LEFTBAR",function(e,t){var n=e.showFeatOnLeftbar;n.data[t]=!1,l.default.set(e,"showFeatOnLeftbar",n),localStorage.setItem("showFeatOnLeftbar",c()(n))}),a);t.a=new u.a.Store({strict:!1,state:b,actions:f,mutations:g})},rBGa:function(e,t){},w7XY:function(e,t,n){"use strict";var s=n("pFYg"),a=n.n(s),o=n("//Fk"),i=n.n(o),r=n("woOf"),c=n.n(r),l=n("mtWM"),u=n.n(l),d=n("Y81h"),p=n.n(d),m=n("UVIz"),h=(n.n(m),n("zL8q")),b=(n.n(h),n("cHtD")),f=n("olkN"),g=n("HL/F"),_=["zh","en"].includes(localStorage.language)?localStorage.language:window.EMQX_DASHBOARD_CONFIG.lang||"en",v=(g.a[_]||g.a.en).httpCode;p.a.configure({showSpinner:!1}),c()(u.a.defaults,{headers:{"Content-Type":"application/json","Cache-Control":"no-cache"},baseURL:"/api/v4",timeout:1e4});var S=0;function w(e){console.error(e),p.a.done(),clearTimeout(S),f.a.dispatch("LOADING",!1);var t=e.response&&e.response.status;return e.response&&e.response.data.message&&(e.message=e.response.data.message),401===t?(f.a.dispatch("USER_LOGIN",{isLogOut:!0}),b.a.push({path:"/login",query:{to:b.a.fullPath}})):404===t?e.message="URL Not Found":function(e){"module_not_loaded"!==e.message&&h.Message.error(e.message)}(e),i.a.reject(e.message)}u.a.interceptors.request.use(function(e){return f.a.state.user.username?e.auth={username:f.a.state.user.username,password:f.a.state.user.password}:b.a.push({path:"/login",query:{to:b.a.fullPath}}),p.a.start(),S=setTimeout(function(){f.a.dispatch("LOADING",!0)},100),e},function(e){console.warn("Request Error: ",e),f.a.dispatch("LOADING",!1)}),u.a.interceptors.response.use(function(e){var t={},n="";if("object"===a()(e.data)){var s=e.status,o=e.data,i=o.code,r=o.meta,c=o.message,l=e.data.data;0!==i&&(n=v[i]||c),r&&(l={items:l,meta:r}),t={data:l,status:s}}if(p.a.done(),clearTimeout(S),S=0,f.a.dispatch("LOADING",!1),n){var u=new Error(n);throw w(u),u}return t},w),t.a=u.a}},[0]);
