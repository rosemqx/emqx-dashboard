    ...
    "qB/b":function(t,e,a){
        ...
        var s=a("fZjL"),
            ...
            p=[
                ...
                {path:"/apps/",name:"add_app",method:"POST",descr:"Add Application"},
                {path:"/apps/:appid",name:"del_app",method:"DELETE",descr:"Delete Application"},
                {path:"/apps/",name:"list_apps",method:"GET",descr:"List Applications"},
                {path:"/apps/:appid",name:"lookup_app",method:"GET",descr:"Lookup Application"},
                {path:"/apps/:appid",name:"update_app",method:"PUT",descr:"Update Application"}
            ],
            l={
                name:"http-api",
                components:{"el-button":i.Button,"el-table":i.Table,"el-table-column":i.TableColumn,"el-card":i.Card},data:function(){return{popoverVisible:!1,nodeName:"emqx@127.0.0.1",tableData:[],nodes:[],responseDate:null,scrollTop:0,uri:""}},computed:{jsonFormatter:function(){var t=o()(this.responseDate,null,"\t");return t=(t=t.replace(/\n/g,"<br />")).replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;")}},watch:{nodeInfo:"setApiData"},methods:{isLink:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return t.target&&-1===t.target.indexOf(":")},init:function(){var t=this,e=this.$store.state.nodeName;
                this.$httpGet("/nodes")
